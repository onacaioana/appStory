    ...
    render() {
        return (
            <Navbar sticky="top" style={{ 'fontSize': '18px', backgroundColor: '#276c90' }} className="navbar-dark text-nowrap bg-dark text-light" expand="md">
                ...
                <img style={{ width: '3%' }} className="mx-2 d-none d-lg-block d-xl-block" src={require("../images/ministerul_justitiei.PNG")}></img>
                ...
                <img style={{ width: '4%' }} className="float-left d-none d-lg-block d-xl-block " src={require("../images/10011.png")}></img>
            </Navbar>
        );
    }
}
