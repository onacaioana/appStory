...
import MyMapComponent from './googleMapMaker';
        ...
        return (
            <div style={style}>
                <div className="card mb-4 bg-light text-dark shadow-lg h-md-250 justify-content-center align-items-center">
                    <h1>Noutăţi</h1>
                    <p className="px-4"><br />In perioada 02 august - 10 septembrie 2018, cereriile si petitiile pentru biroul de informare si relatii publice se vor trimite la adresa de e-mail a registraturii: tr-cluj-reg@just.ro !!!</p>
                    <p>sdjsdhkfsdfhk</p>
                    <p>sdjsdhkfsdfhk</p>
                    ...
                    <div className="col-md-4">
                        <div className="card mb-4 shadow-lg h-md-250">
                            ...
                            <div className="card-body" >
                                <p className="card-text"><b> Registratură: </b>0748 523.258</p>
                                <p className="card-text"><b> Arhivă: </b>0748 523.258</p>
                                <p className="card-text"><b>Purtator de cuvant: </b>0748 523.258</p>
                            </div>
                        </div>
                    </div>
