...
class App extends Component {
  ...
  renderForNoCompatibility() {
    return (
      <div>
        <p>Acest site nu suporta aceasta versiune de browser. Va rugam sa updataţi browserul dumneavostră sau să folositi Chrome sau FireFox </p>
      </div>
    )
  }
    ...
    return (
      <React.Fragment>
        ...
        <HashRouter basename={baseUrl} component={App}>
          <div>
            <Switch>
              <Route exact path={['/organizare', '/contact', '/taxe', '/prezentare', '/rapoarte', '/hotarari', '/concurs', '/declaratii', '/infoPublice', '/comunicate', '/']} component={Meniu} />
            </Switch>
            ...
            <Switch>
              <Route exact path={['/organizare', '/contact', '/taxe', '/prezentare', '/rapoarte', '/hotarari', '/concurs', '/declaratii', '/infoPublice', '/comunicate', '/']} component={Footer} />
            </Switch>
          </div>
        </HashRouter >
      </React.Fragment>
